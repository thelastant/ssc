<div id="agent-coin-dom" class="common container">
                ...
                <div class="item">
                    ...
                    <div class="item-data">
                        <?php foreach ($vs as $k => $v) { ?>
                            <a href="javascript:;"
                               data-type="<?php echo $k; ?>"<?php if ($args['type'] === $k) echo ' class="active"'; ?>><?php echo $v; ?></a>
                        <?php } ?>
                    </div>
                </div>
            <?php } ?>
    ...
    <div class="head" style="margin-top: 15px">
        ...
        <form action="/agent/coin" class="search" method="get">
            <div class="select trans fixed" id="select-type">
                ...
                <span class="text"
                      style="color: #fff;"
                      id="text-type"><?php echo $args['type'] ? $this->coin_types[$args['type']] : '请选择帐变类型'; ?></span>
            </div>
