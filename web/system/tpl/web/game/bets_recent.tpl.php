    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
        ...
        <?php foreach ($bets_recent as $var) { ?>
            <tr>
                ...
                <?php } ?>
                <td><a class="ajax-bet-info"
                       href="/bet/info?id=<?php echo $var['id']; ?>"><?php echo $var['wjorderId']; ?></a></td>
                ...
                <td><?php echo $var['lotteryNo'] ? number_format($var['bonus'], 4, '.', '') : '0.00'; ?></td>
                <td class="lotteryNo"
                    title="<?php echo $var['lotteryNo'] ? $var['lotteryNo'] : '--'; ?>"><?php echo $var['lotteryNo'] ? $var['lotteryNo'] : '--'; ?></td>
                <td>
                    <?php
                    if ($var['isDelete'] == 1) {
