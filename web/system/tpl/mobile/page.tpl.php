...
<div id="page">
    ...
    <?php } else { ?>
        ...
        <a href="<?php echo page_url($page_prev, $page_url); ?>"
           class="icon-angle-left" <?php echo $page_attr; ?>>上一页</a>
        <?php
    }
    ...
    <?php } else { ?>
        <a href="<?php echo page_url($page_next, $page_url); ?>"
           class="icon-angle-right" <?php echo $page_attr; ?>>下一页</a>
        <a href="<?php echo page_url($page_max, $page_url); ?>"
           class="icon-angle-double-right" <?php echo $page_attr; ?>>尾页</a>
    <?php } ?>
