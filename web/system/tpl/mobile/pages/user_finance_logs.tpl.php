 ...
 */
?>
<user_finance_logs class="app-page">
        ...
        <div id="financeLogsApp" class="content container">
            ...
            <div class="table-box">
                <div class="row table-head">
                    ...
                    <div class="phone-3 column">说明</div>
                </div>
                ...
                var vm = new Vue({
                    ...
                    methods: {
                        ...
                        getCoinLogs: function () {
                            ...
                            LoadStart();
                            _self.data_list = [];
                            $.post(api.API_ROUTES.get_coin_logs, {type: _self.type, page: _self.p}, function (ret) {
                                if (ret.code === 200) {
